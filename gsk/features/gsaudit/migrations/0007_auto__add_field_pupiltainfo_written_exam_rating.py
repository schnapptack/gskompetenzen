...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PupilTAInfo.written_exam_rating'
        db.add_column('gsaudit_pupiltainfo', 'written_exam_rating', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PupilTAInfo.written_exam_rating'
        db.delete_column('gsaudit_pupiltainfo', 'written_exam_rating')
