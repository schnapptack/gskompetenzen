...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PupilAuditSkill.diagnosis'
        db.add_column('gsaudit_pupilauditskill', 'diagnosis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PupilAuditSkill.diagnosis'
        db.delete_column('gsaudit_pupilauditskill', 'diagnosis')
