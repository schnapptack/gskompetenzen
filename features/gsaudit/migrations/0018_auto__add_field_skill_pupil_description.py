...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.pupil_description'
        db.add_column(u'gsaudit_skill', 'pupil_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.pupil_description'
        db.delete_column(u'gsaudit_skill', 'pupil_description')
