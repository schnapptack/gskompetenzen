...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subject.skill'
        db.delete_column('gsaudit_subject', 'skill_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Subject.skill'
        raise RuntimeError("Cannot reverse this migration. 'Subject.skill' and its values cannot be restored.")
