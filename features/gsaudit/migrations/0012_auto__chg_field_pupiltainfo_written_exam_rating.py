...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PupilTAInfo.written_exam_rating'
        db.alter_column('gsaudit_pupiltainfo', 'written_exam_rating', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # Changing field 'PupilTAInfo.written_exam_rating'
        db.alter_column('gsaudit_pupiltainfo', 'written_exam_rating', self.gf('django.db.models.fields.FloatField')())
    models = {
        'auth.group': {
