...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audit.date'
        db.alter_column(u'gsaudit_audit', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Audit.date'
        db.alter_column(u'gsaudit_audit', 'date', self.gf('django.db.models.fields.DateTimeField')())
