...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeachingAssignment.default_skill_level'
        db.delete_column(u'gsaudit_teachingassignment', 'default_skill_level')

        # Adding field 'TeachingAssignment.min_skill_level'
        db.add_column(u'gsaudit_teachingassignment', 'min_skill_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TeachingAssignment.max_skill_level'
        db.add_column(u'gsaudit_teachingassignment', 'max_skill_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TeachingAssignment.default_skill_level'
        db.add_column(u'gsaudit_teachingassignment', 'default_skill_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TeachingAssignment.min_skill_level'
        db.delete_column(u'gsaudit_teachingassignment', 'min_skill_level')

        # Deleting field 'TeachingAssignment.max_skill_level'
        db.delete_column(u'gsaudit_teachingassignment', 'max_skill_level')
