...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pupil.school'
        db.add_column(u'gsaudit_pupil', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gsaudit.School']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pupil.school'
        db.delete_column(u'gsaudit_pupil', 'school_id')
