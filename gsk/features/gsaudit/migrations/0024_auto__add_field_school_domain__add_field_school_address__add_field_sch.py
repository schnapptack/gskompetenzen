...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.domain'
        db.add_column(u'gsaudit_school', 'domain',
                      self.gf('django.db.models.fields.CharField')(default='gsk', max_length=200),
                      keep_default=False)

        # Adding field 'School.address'
        db.add_column(u'gsaudit_school', 'address',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'School.contact_person'
        db.add_column(u'gsaudit_school', 'contact_person',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.domain'
        db.delete_column(u'gsaudit_school', 'domain')

        # Deleting field 'School.address'
        db.delete_column(u'gsaudit_school', 'address')

        # Deleting field 'School.contact_person'
        db.delete_column(u'gsaudit_school', 'contact_person')
