...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pupil.birthday'
        db.alter_column('gsaudit_pupil', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))
    def backwards(self, orm):

        # Changing field 'Pupil.birthday'
        db.alter_column('gsaudit_pupil', 'birthday', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 10, 7, 0, 0)))
    models = {
        'auth.group': {
