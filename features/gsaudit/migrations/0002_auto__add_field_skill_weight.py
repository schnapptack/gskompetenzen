...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.weight'
        db.add_column('gsaudit_skill', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.weight'
        db.delete_column('gsaudit_skill', 'weight')
