...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeachingAssignment.note'
        db.add_column('gsaudit_teachingassignment', 'note', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeachingAssignment.note'
        db.delete_column('gsaudit_teachingassignment', 'note')
