...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gsaudit_teachingassignment', 'skill_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teaching_assignments_2', null=True, to=orm['gsaudit.Skill']),
                      keep_default=False)
    ...
    models = {
        ...
        u'gsaudit.teachingassignment': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'skill': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gsaudit.Skill']"}),
            'skill_2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'teaching_assignments_2'", 'null': 'True', 'to': u"orm['gsaudit.Skill']"}),
