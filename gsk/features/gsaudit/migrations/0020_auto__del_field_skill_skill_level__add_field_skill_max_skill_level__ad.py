...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Skill.skill_level'
        db.delete_column(u'gsaudit_skill', 'skill_level')

        # Adding field 'Skill.max_skill_level'
        db.add_column(u'gsaudit_skill', 'max_skill_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Skill.min_skill_level'
        db.add_column(u'gsaudit_skill', 'min_skill_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Skill.skill_level'
        db.add_column(u'gsaudit_skill', 'skill_level',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Skill.max_skill_level'
        db.delete_column(u'gsaudit_skill', 'max_skill_level')

        # Deleting field 'Skill.min_skill_level'
        db.delete_column(u'gsaudit_skill', 'min_skill_level')
