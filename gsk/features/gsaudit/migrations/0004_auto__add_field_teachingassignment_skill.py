...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeachingAssignment.skill'
        db.add_column('gsaudit_teachingassignment', 'skill', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gsaudit.Skill']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeachingAssignment.skill'
        db.delete_column('gsaudit_teachingassignment', 'skill_id')
