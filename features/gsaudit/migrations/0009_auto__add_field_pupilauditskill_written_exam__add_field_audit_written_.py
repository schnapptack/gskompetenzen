...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PupilAuditSkill.written_exam'
        db.add_column('gsaudit_pupilauditskill', 'written_exam',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Audit.written_exam'
        db.add_column('gsaudit_audit', 'written_exam',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PupilAuditSkill.written_exam'
        db.delete_column('gsaudit_pupilauditskill', 'written_exam')

        # Deleting field 'Audit.written_exam'
        db.delete_column('gsaudit_audit', 'written_exam')
