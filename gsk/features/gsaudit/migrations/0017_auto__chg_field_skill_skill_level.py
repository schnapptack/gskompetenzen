...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Skill.skill_level'
        db.alter_column(u'gsaudit_skill', 'skill_level', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Skill.skill_level'
        db.alter_column(u'gsaudit_skill', 'skill_level', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'gsaudit.skill': {
            ...
            'skill_level': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
